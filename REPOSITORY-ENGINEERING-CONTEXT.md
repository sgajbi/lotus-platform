...
| Client-demo certification | [Lotus Client Demo Certification Standard](./docs/standards/Lotus%20Client%20Demo%20Certification%20Standard.md), then the [Client Demo Pack Template](./docs/demo/client-demo-pack-template.md) |
