...
| Canonical front-office readiness validation | `automation/Invoke-Canonical-FrontOffice-QA.ps1 -BringUp` | Bring up the governed `lotus-workbench` runtime, run the DPM command-center seed, and validate populated UI/product surfaces |
