...
| Canonical front-office mainline certification | `automation/Invoke-Canonical-FrontOffice-QA.ps1 -BringUp -RequireMainlineSources` | Fail closed unless every canonical participant is clean and exactly at `origin/main` before Docker build, seed, validation, screenshots, and Lotus Idea readiness evidence |
