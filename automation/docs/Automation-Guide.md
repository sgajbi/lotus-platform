...
mandate health. Portfolio identity, business date, and percentage-to-ratio normalization must all
validate; missing or contradictory source evidence fails the seed instead of using a fallback.
