...
| Canonical all-app clean rebuild | `automation/Invoke-Canonical-FrontOffice-QA.ps1 -Clean -BringUp -BuildImages` | Run the governed front-office clean rebuild and also build/probe `lotus-idea` through its app-local Docker runtime, direct host `8330`, and `idea.dev.lotus` ingress |
