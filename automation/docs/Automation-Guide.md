...
| Canonical front-office clean core rebuild | `automation/Invoke-Canonical-FrontOffice-QA.ps1 -BringUp -CleanCoreState -BuildImages` | Reset `lotus-core` state, rebuild service images, reseed the governed portfolio, and validate populated UI/product surfaces |
