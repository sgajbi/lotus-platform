...
def validate_final_closure(
    *,
    ...
    if observability_contract.get("lifecycle_status") != "final-closure-implemented":
        errors.append(
            "analytics-ui-observability-contract lifecycle_status must be final-closure-implemented"
        )
