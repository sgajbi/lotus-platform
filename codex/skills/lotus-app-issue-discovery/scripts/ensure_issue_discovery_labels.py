...
LABELS = [
    ...
    ("lens/secure-development-threat-modeling", "1f6feb", "Lens: secure development, threat models, trust boundaries, abuse cases"),
    ("lens/identity-access-management", "1f6feb", "Lens: identity, authentication, authorization, workload identity, bypass safety"),
    ("lens/container-runtime-hardening", "1f6feb", "Lens: container user, filesystem, capabilities, resources, egress, runtime assets"),
    ("lens/vulnerability-management", "1f6feb", "Lens: vulnerability lifecycle, exceptions, remediation, penetration-test readiness"),
    ("lens/incident-response", "1f6feb", "Lens: incident detection, containment, recovery, evidence, corrective action"),
    ...
    ("lens/environment-supply-chain-provenance", "1f6feb", "Lens: image labels, SBOM, scan, signing, provenance, digest deploys"),
