...
| `RFC-0093` | `active` | in progress; contract foundation and context playbook adoption implemented | Lotus context assembly and compaction hardening for agentic development |
| `RFC-0094` | `active` | in progress; contract foundation, background-run ledger state, and context playbook adoption implemented | Durable background engineering task ledger and governed delegation model |
