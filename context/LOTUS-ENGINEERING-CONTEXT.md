...
10. RFC-0104 is in progress for batch reporting. Slice 0 strengthens
   ...
   daemonized worker-process execution, and config-backed internal scheduler-process
   materialization. Gateway exposure, Workbench UI, all-active scheduler materialization, manifest
   scheduler materialization, RFC-0105 dashboards/replay, RFC-0106 security certification, and
   RFC-0107 production certification remain pending later work.
