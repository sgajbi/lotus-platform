...
| Standardize or refresh repository README and wiki documentation across Lotus repos, including business-application feature material, diagrams, implementation-backed demo readiness, and current functional/non-functional posture | `lotus-readme-wiki-governance` | repo delivery governance skill, `lotus-rfc-review-loop` | repo-local engineering context, existing public-doc regression tests when present, `docs/documentation/LOTUS-DOCUMENTATION-LAYERING.md`, `context/TASK-ROUTING-GUIDE.md`, and repo-local `wiki/` as the authored source when publishing |
...
| Review, standardize, or create Lotus RFCs and governance docs, including pre-implementation gold-standard hardening with business outcomes, supported-feature ledgers, mandatory slices, and enterprise/data-mesh baselines | `lotus-rfc-review-loop` | `lotus-readme-wiki-governance` when README/wiki product material changes | RFC file plus central platform context |
