...
| Launch or monitor detached platform automation profiles and local background runs | `platform-automation-ops` | `async-task-runner`, `lotus-pr-premerge-gate` | `context/playbooks/AGENT-CONTEXT-AND-TASK-LEDGER.md`, `platform-contracts/agent-engineering/engineering-task-ledger-contract.v1.json`, `automation/Start-Background-Run.ps1`, `automation/Check-Background-Runs.ps1` |
