...
5. RFC-0076 contract files under `lotus-platform/context/contracts/`, including `canonical-front-office-demo-data-contract.json`, are the machine-readable source of truth for the canonical front-office dataset; version 1.1 governs `PM_SG_001` as the distinct advisor-book portfolio manager without reusing Advisor Cockpit identity or overstating source-confirmed tenant scope,
