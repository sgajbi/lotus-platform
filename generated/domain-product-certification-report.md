...
| `AdvisoryCopilotInteractionRecord` | `lotus-advise` | `certified` | `0` | `True` | `True` |
...
| `PositionTimeseriesInput` | `lotus-core` | `certified` | `0` | `True` | `True` |
...
| `RollingRiskMetricsReport` | `lotus-risk` | `certified` | `0` | `True` | `True` |
...
| `lotus-gateway` | `certified` | `5` | `0` |
| `lotus-idea` | `certified` | `17` | `0` |
| `lotus-manage` | `certified` | `29` | `0` |
| `lotus-performance` | `certified` | `10` | `0` |
