...
| `lotus-core` | `certified_first_wave` | `producer` | `15` | `0` | Add runtime telemetry, SLO, access, lifecycle, and evidence-pack maturity controls for this producer. |
...
| --- | --- | --- | --- | --- | --- |
| `lotus-advise:AdvisoryProposalLifecycleRecord:v1` | `lotus-advise` | `certified_first_wave` | `enterprise_wave_1` | `active` | Add RFC-0091 runtime, SLO, access, lifecycle, and evidence-pack controls. |
...
| `lotus-core:PortfolioStateSnapshot:v1` | `lotus-core` | `certified_first_wave` | `enterprise_wave_1` | `active` | Add RFC-0091 runtime, SLO, access, lifecycle, and evidence-pack controls. |
...
| `lotus-risk:RiskMetricsReport:v1` | `lotus-risk` | `certified_first_wave` | `enterprise_wave_1` | `active` | Add RFC-0091 runtime, SLO, access, lifecycle, and evidence-pack controls. |
