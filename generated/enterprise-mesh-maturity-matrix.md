...
| `lotus-core` | `certified_first_wave` | `producer` | `41` | `0` | Maintain repo-native declaration, trust telemetry, SLO, access, lifecycle, evidence-pack, and certification-gate posture. |
...
| `lotus-manage` | `certified_first_wave` | `producer` | `3` | `14` | Maintain repo-native declaration, trust telemetry, SLO, access, lifecycle, evidence-pack, and certification-gate posture. |
