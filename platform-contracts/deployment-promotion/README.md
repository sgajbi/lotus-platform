...
An environment can be out of scope only with an explicit reason and follow-up evidence. Out-of-scope
production remains non-certified until live deployment proof exists.
