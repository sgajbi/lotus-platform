...
| tests/unit/test_engineering_context_system_contract.py | 2651 | .py |
...
- Unit tests collected: `1499`
- Collection command return code: `0`
- Collection summary: `1499 tests collected`
