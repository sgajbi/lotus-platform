...
| tests/unit/test_engineering_context_system_contract.py | 2725 | .py |
...
- Unit tests collected: `1500`
- Collection command return code: `0`
- Collection summary: `1500 tests collected`
