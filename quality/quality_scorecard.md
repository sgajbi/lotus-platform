...
Generated: `2026-09-06T16:20:24Z`
...
| --- | --- | --- | --- |
| Code health | Current max complexity 55 and largest function 903 lines | Reduce current hotspots without behavior drift | Largest files, highest-complexity functions, and completed extraction history are recorded in the baseline and health report. |
...
| Tests | 1379 unit tests collected | Focused coverage added per slice | Collection result recorded. |
| Security | Keyword review sample measured | Scanner-backed findings clean or governed | Dependency and container vulnerability exceptions have a versioned report-only register schema and deterministic validator before dependency/security or release-image lane promotion. |
