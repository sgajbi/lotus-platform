...
Generated: `2026-08-26T15:52:48Z`
...
| --- | --- | --- | --- |
| Code health | Current max complexity 31 and largest function 903 lines | Reduce current hotspots without behavior drift | Largest files, highest-complexity functions, and completed extraction history are recorded in the baseline and health report. |
...
| Tests | 1091 unit tests collected | Focused coverage added per slice | Collection result recorded. |
