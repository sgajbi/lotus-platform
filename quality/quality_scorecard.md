...
Generated: `2026-09-16T12:10:56Z`
...
| --- | --- | --- | --- |
| Code health | Current max complexity 82 and largest function 903 lines | Reduce current hotspots without behavior drift | Largest files, highest-complexity functions, and completed extraction history are recorded in the baseline and health report. |
...
| Tests | 1901 unit tests collected | Focused coverage added per slice | Collection result recorded. |
