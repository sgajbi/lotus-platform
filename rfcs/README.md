...
- `RFC-0104-batch-reporting-scheduler-concurrency-and-recovery.md` (in progress; Slice 0 platform scaffold guardrails and Slice 1 `lotus-report` batch-orchestrator module boundary are implemented, with batch ledger, scheduler, APIs, concurrency, retry, resume, progress, and recovery runtime behavior still pending)
