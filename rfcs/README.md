...
- `RFC-0108-front-office-analytics-ui-observability-and-operational-posture.md` (gold-pass ready; implementation not started; governed front-office analytics UI observability across Workbench browser rendering, gateway/BFF/API delivery, backend analytics fan-out, user-visible freshness/degraded/empty/error states, attention and audit events, no-sensitive-content controls, supported-features governance, and canonical proof through `PB_SG_GLOBAL_BAL_001`; this is not an extension of RFC-0105 reporting observability)
