...
- `RFC-0104-batch-reporting-scheduler-concurrency-and-recovery.md` (in progress; Slice 0 platform scaffold guardrails, Slice 1 `lotus-report` batch-orchestrator module boundary, and Slice 2 internal durable batch/item materialization are implemented, with scheduler, APIs, concurrency, retry, resume, progress, and recovery runtime behavior still pending)
