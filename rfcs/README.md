...
2. RFC-0100 through RFC-0103 have implementation-backed first-wave reporting, rendering, and
   ...
   dispatch/recovery, internal execution, bounded worker, run-once operator API, runtime-pass, and
   worker-process, and scheduler-process slices implemented; continue RFC-0104 gateway/UI and
   broader scheduler-materialization slices before RFC-0105, RFC-0106, then RFC-0107.
