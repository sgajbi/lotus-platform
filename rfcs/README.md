...
- `RFC-0093-lotus-context-assembly-and-compaction-hardening-for-agentic-development.md` (implemented on active branch; context assembly, identifier preservation, procedural memory, skill guidance, AGENTS guidance, wiki source, and validation evidence complete pending merge)
- `RFC-0094-durable-background-engineering-task-ledger-and-governed-delegation-model.md` (implemented on active branch; task-ledger contract, background-run ledger state, lifecycle vocabulary, skill guidance, AGENTS guidance, wiki source, and validation evidence complete pending merge)
