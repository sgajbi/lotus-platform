...
- `RFC-0091-enterprise-data-mesh-maturity-and-production-readiness.md` (in progress; Slices 0-5 maturity matrix, self-service onboarding, telemetry collection, mesh SLO enforcement, access governance, and evidence packs implemented)
