...
2. RFC-0100 through RFC-0103 have implementation-backed first-wave reporting, rendering, and
   ...
   dispatch/recovery, internal execution, bounded worker, and run-once operator API slices
   implemented; continue RFC-0104 scheduler/runtime slices before RFC-0105, RFC-0106, then
   RFC-0107.
