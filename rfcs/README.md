...
- `RFC-0093-lotus-context-assembly-and-compaction-hardening-for-agentic-development.md` (draft; recovered from the pre-mesh 0084 numbering, renumbered after RFC-0084 through RFC-0092 were assigned to the mesh program, and tightened for gold-standard implementation closure)
- `RFC-0094-durable-background-engineering-task-ledger-and-governed-delegation-model.md` (draft; recovered from the pre-mesh 0085 numbering, renumbered after RFC-0084 through RFC-0092 were assigned to the mesh program, and tightened for gold-standard implementation closure)
