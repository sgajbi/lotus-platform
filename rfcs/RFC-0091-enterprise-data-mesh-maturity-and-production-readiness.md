...
2. produce a maturity matrix by repository and product,
...
6. add tests proving a valid scaffold passes and incomplete scaffolds fail.
...
7. update shared memory and remove stale active claims if agents worked in parallel,
8. complete PR evidence, merge readiness, and branch hygiene.
...
2. onboarding scaffold tests,
3. runtime telemetry emission tests in participating producer repos,
4. gateway API contract tests for access posture and evidence manifests,
5. Workbench unit and browser smoke tests for entitled discovery and evidence-pack states,
6. mesh certification gate tests for runtime evidence, SLO drift, access drift, lifecycle drift,
   and evidence history,
7. local blocking cross-repo mesh certification,
8. GitHub cross-repo mesh certification workflow,
9. Feature Lane and PR Merge Gate in all touched repos.
...
10. Slice 8 and Slice 9 are completed according to `RFC-GOVERNANCE-STANDARD.md`.
