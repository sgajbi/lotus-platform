...
when any completed performance supportability surface is enabled, and lotus-risk PR #109 proves
explicit risk `metric_labels` plus no-sensitive Prometheus label boundaries for risk
supportability and backend freshness metrics.
