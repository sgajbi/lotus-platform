...
def test_task_profiles_wire_service_addressing_validator_into_governance_profiles() -> None:
...
def test_agent_and_pulse_include_service_addressing_validation() -> None:
    ...
    expected_snippet = 'automation/Validate-Service-Addressing.ps1'
