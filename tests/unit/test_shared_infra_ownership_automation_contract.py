...
def test_task_profiles_wire_shared_infra_ownership_validator_into_governance_profiles() -> None:
...
def test_agent_and_pulse_include_shared_infra_ownership_validation() -> None:
    ...
    expected_snippet = 'automation/Validate-Shared-Infrastructure-Ownership.ps1'
