...
| `lotus-idea` | `IdeaCandidate:v1` is a governed certification candidate with platform SLO, access, evidence-policy, source-manifest, and telemetry-collection coverage; it remains fail-closed and not certified or supported-feature promoted until runtime records, durable repository proof, Gateway/Workbench discovery, mesh event-publication evidence, and promotion evidence pass. RFC-0002 proof consumption is bounded: broker runtime, downstream-consumer runtime, cost-attribution contract, deployment-promotion readiness, and mesh-readiness proofs may satisfy only their named dependency markers. These proofs do not certify platform mesh event publication, Gateway/Workbench live journeys, data-product certification, supported-feature promotion, production posture, required-product promotion, or broader downstream/product readiness. |
