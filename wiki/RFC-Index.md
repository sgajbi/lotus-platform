...
- [RFC-0104](../rfcs/RFC-0104-batch-reporting-scheduler-concurrency-and-recovery.md)
  ...
  internal runtime-pass primitive plus daemonized internal worker process are implemented, with
  scheduler loop/schedule-cycle automation, gateway exposure, Workbench surface, RFC-0105
  dashboards/replay, RFC-0106 security certification, and RFC-0107 production certification still
  pending
...
2. RFC-0100 through RFC-0103 now have implementation-backed first-wave reporting, rendering, and
   ...
   run-once operator API, runtime-pass, and worker-process slices implemented; continue RFC-0104
   scheduler/gateway/UI slices before RFC-0105, RFC-0106, then RFC-0107.
...
- RFC-0100 through RFC-0103 are implemented for first-wave reporting, rendering, and archival scope.
  ...
  worker process implemented. Continuous scheduler loop/schedule-cycle automation, gateway
  exposure, and Workbench batch UI remain pending. RFC-0105 through RFC-0107 remain the next
